		...
		<div class="col-lg-12 col-md-12 row-tab">
			<div id="org-panel" class="panel panel-default common-wrapper">
				<div class="panel-heading common-part">
					<i class="iconfont">&#xe6ca;</i><span>spark主机列表</span>
				</div>
...
<div id="addSparkHost" class="dialog-wrap">
	<form id="addSparkHostForm" class="form-inline" data-validator-option="{timely:2, theme:'yellow_right'}">
		<table class="form-table" border="0">
			...
			<tr>
				<div class="form-group">
					...
					<td>
						<select class="form-control input-sm" name="sparkVersion" id="sparkVersion" data-rule="required;" style="width: 85%;">
							<option value =""></option>
							<option value ="apache1.3.1">apache1.3.1</option>
							<option value ="1.5.0-cdh5.5.4">1.5.0-cdh5.5.4</option>
						</select>
					</td>
				</div>
			</tr>
			<tr>
				<div class="form-group">
					<td><label for="installPath">SPARK_HOME:</label></td>
					<td colspan="3">
						<input type="text" class="form-control input-sm" style="width: 95%;" name="installPath" placeholder="请输入spark安装路径" data-rule="required;"/>
					</td>
				</div>
			</tr>
		</table>
...
<div id="editSparkHost" class="dialog-wrap">
	<form id="editSparkHostForm" class="form-inline" data-validator-option="{timely:2, theme:'yellow_right'}">
...
<script src="<%=webpath%>/resources/js/host/host_spark_manage.js"></script>
</body>
</html>
	...
	<form id="parseOptForm">
	    <div class="containerInfo">
	        <div class="form-group">
	            <label for="separator">分隔符:</label>&nbsp;<input type="text" class="form-control input-sm" style="width: 20%;" value="" name="separator" id="separator"/>
	        </div>
	        <div>
	            <table class="table table-fixedLength form-table" id="parseOptTable">
	                ...
	                <tbody>
	                    <tr class="addOneFixedBtn">
	                        <td colspan="7"><a class="addOneFixedLength"><i class="fa fa-plus"></i>添加</a></td>
	                    </tr>
	                </tbody>
	            </table>
	        </div>
    ...
    <script type="text/javascript">
	    $(function() {
	    	...
	    	if(optDef!=null & optDef!=''){
		    	optDef = eval('(' + optDef + ')');
	   			var separator = optDef.separator;
	   			...
	   			for(var i=0,length=optField.length;i<optField.length;i++){
					...
					var param = "<tr>" 
				        ...
				        +'<td><a onclick="delOneFixedLength(this)"><i class="fa fa-trash"></i></a></td>'
				        +'</tr>';

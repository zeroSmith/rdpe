...
<body style="overflow: hidden;">
		...
		<div class="col-lg-12 col-md-12 row-tab">
			<div id="org-panel" class="panel panel-default common-wrapper">
				<div class="panel-heading common-part">
					<i class="iconfont">&#xe6ca;</i><span>spark事件列表</span>
				</div>
			...
			<table class="form-table">
				<tr>
					<div class="form-group">
						...
						<td style="width:35%"><label title="custom"><input
								type="radio" value="custom" name="eventType"
	...
	<script src="<%=webpath%>/resources/js/event/event_spark_manage.js"></script>

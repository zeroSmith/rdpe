...
win.window({title:_265,noheader:(_265?false:true),width:300,height:"auto",closable:false,modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,onClose:function(){
setTimeout(function(){
win.window("destroy");
},100);
}});
